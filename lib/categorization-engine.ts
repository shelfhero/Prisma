...
const KEYWORD_RULES = {
  basic_foods: [
    ...
    'пържола', 'котлет', 'карначе', 'кюфте', 'телешко',

    // Риба (Fish)
    'риба', 'сьомга', 'сьомга', 'скумрия', 'тон', 'паламуд', 'цаца', 'пъстърва',
    'морски', 'морска', 'калмар', 'октопод', 'скарида', 'миди',

    // Млечни (Dairy)
    'мляко', 'сирене', 'кашкавал', 'йогурт', 'кисело', 'масло', 'извара', 'крема',
  ...
  snacks: [
    ...
    'царевица', 'стик', 'пуканки', 'локум', 'халва', 'тахан', 'мед',
  ],
  ...
  drinks: [
    ...
    'нектар', 'витаминка', 'алкохол', 'алкохолна',
  ],
  ...
  personal_care: [
    ...
    'антиперспирант', 'слънцезащитен', 'след слънце',
  ],
};
